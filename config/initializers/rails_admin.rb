# RailsAdmin config file. Generated on April 15, 2012 17:09
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Jumpness Core', 'Admin']
  ...
  # config.excluded_models = [Company, Inflatable, Phone, Photo, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Company, Inflatable, Phone, Photo, User]
  ...
  #   # Found associations:
  #     configure :inflatable, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :inflatable_id, :integer         # Hidden 
  ...
  #   # Found associations:
  #     configure :companies, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
