...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { company_id: @phone.company_id, number: @phone.number, phone_type: @phone.phone_type, provider: @phone.provider }
    end
  ...
  test "should update phone" do
    put :update, id: @phone, phone: { company_id: @phone.company_id, number: @phone.number, phone_type: @phone.phone_type, provider: @phone.provider }
    assert_redirected_to phone_path(assigns(:phone))
  end
